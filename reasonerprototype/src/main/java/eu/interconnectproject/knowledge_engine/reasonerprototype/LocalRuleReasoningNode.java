...
public class LocalRuleReasoningNode extends RuleReasoningNode {

	private final KeReasoner keReasoner;
	private final LocalRule rule;
	...
	public LocalRuleReasoningNode(SingleObjectiveReasoningNode parent, KeReasoner keReasoner, LocalRule rule,
