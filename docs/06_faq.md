...
*Question*: Why do these two KBs not exchange data, while they should?
- *Answer*: 
|               |                                         |     POST                |                                         |     ASK    |
|---------------|-----------------------------------------|-------------------------|-----------------------------------------|------------|
|               |                                         |     only argument GP    |     both argument      and result GP    |     n/a    |
|     REACT     |     only argument GP                    |     yes                 |     no                                  |     n/a    |
|               |     both argument      and result GP    |     no                  |     yes                                 |     n/a    |
|     ANSWER    |     n/a                                 |     n/a                 |     n/a                                 |     yes    |
