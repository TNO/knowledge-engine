...
*Question*: <a name="connect_keruntime"> There is an existing Knowledge Engine Runtime (KER) that I want to use to develop a knowledge base. How do I connect to this KER?
