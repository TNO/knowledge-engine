...
public interface AnswerHandler {
	 ...
	 * 
	 * @param anAKI                The {@link KnowledgeInteraction} that is involved
	 *                             in the question top answer.
	 * @param anAnswerExchangeInfo An {@link AnswerExchangeInfo}, containing a set
	 *                             of {@link Binding}s for variables in the
	 *                             {@link KnowledgeInteraction}'s
	 *                             {@link GraphPattern}, and more information such
	 *                             as the ID of the ASKing knowledge base.
	 * @return A future of all {@link Binding}s that match this
	 *         {@link KnowledgeInteraction}'s {@link GraphPattern}, AND matches ANY
	 *         of the input BindingSet. All variables from the {@link GraphPattern}
	 *         are bound, including the ones that were already provided in the input
	 *         {@link BindingSet}. If not, you would not be able to know which
	 *         partial binding output corresponded with which partial binding input.
	 *         Should not return null.
	 */
	public default CompletableFuture<BindingSet> answerAsync(AnswerKnowledgeInteraction anAKI,
	 ...
	 *         corresponded with which partial binding input. Should not return
	 *         null.
	 */
