...
public class TestSuspendedKnowledgeBase {
    ...
    public void testSuspendingKnowledgeBase() throws MalformedURLException {
        ...
        HttpTester registerKb = new HttpTester(new URL(url + "/sc"),
                "POST",
                "{\"knowledgeBaseId\": \"http://example.com/kb1\", " +
                        "\"knowledgeBaseName\": \"KB1\", " +
                        "\"knowledgeBaseDescription\": \"KB1\"}", Map.of(
                "Content-Type", "application/json",
                "Accept", "*/*"
        ));
        registerKb.expectStatus(200);
        HttpTester registerKb2 = new HttpTester(new URL(url + "/sc"),
                "POST",
                "{\"knowledgeBaseId\": \"http://example.com/kb2\", " +
                        "\"knowledgeBaseName\": \"KB2\", " +
                        "\"knowledgeBaseDescription\": \"KB2\"}", Map.of(
                "Content-Type", "application/json",
                "Accept", "*/*"
        ));
        ...
        var sc1 = new AsyncTester(() -> {
            try {
                HttpTester registerAsk = new HttpTester(new URL(url + "/sc/ki"),
                        "POST",
                        "{\"knowledgeInteractionType\": \"AskKnowledgeInteraction\", " +
                                "\"knowledgeInteractionName\": \"ask\"," +
                                "\"graphPattern\": \"?a ?b ?c.\"}",
                        Map.of(
                                "Knowledge-Base-Id", "http://example.com/kb1",
                                "Content-Type", "application/json",
                                "Accept", "*/*"
                        )
                );
                ...
                HttpTester executeAsk = new HttpTester(new URL(url + "/sc/ask"),
                        "POST", "[{}]",
                        Map.of(
                                "Knowledge-Base-Id", "http://example.com/kb1",
                                "Knowledge-Interaction-Id", "http://example.com/kb1/interaction/ask",
                                "Content-Type", "application/json",
                                "Accept", "*/*"
                        )
                );
                ...
                for (int i = 0; i < NUM_UNHANDLED_REQUESTS; i++) {
                    ...
                    new AsyncTester(() -> {
                        ...
                        try {
                            executeAsk1 = new HttpTester(new URL(url + "/sc/ask"),
                                    "POST", "[{}]",
                                    Map.of(
                                            "Knowledge-Base-Id", "http://example.com/kb1",
                                            "Knowledge-Interaction-Id", "http://example.com/kb1/interaction/ask",
        ...
        var sc2 = new AsyncTester(() -> {
            try {
                HttpTester registerAnswer = new HttpTester(new URL(url + "/sc/ki"),
                        "POST",
                        "{\"knowledgeInteractionType\": \"AnswerKnowledgeInteraction\", " +
                                "\"knowledgeInteractionName\": \"answer\"," +
                                "\"graphPattern\": \"?a ?b ?c.\"}",
                        Map.of(
                                "Knowledge-Base-Id", "http://example.com/kb2",
                                "Content-Type", "application/json",
                                "Accept", "*/*"
                        )
                );
                ...
                HttpTester waitForRequest = new HttpTester(new URL(url + "/sc/handle"),
                        "GET", null,
                        Map.of(
                                "Knowledge-Base-Id", "http://example.com/kb2",
                                "Content-Type", "application/json",
                ...
                var postAnswer = new HttpTester(new URL(url + "/sc/handle"), "POST", """
                        ...
                        Map.of("Content-Type", "application/json",
                                "Accept", "*/*",
                                "Knowledge-Base-Id", "http://example.com/kb2",
                                "Knowledge-Interaction-Id", "http://example.com/kb2/interaction/answer"));
                postAnswer.getBody();
                System.out.println("Posted answer");

                latch.await();

                HttpTester deleteSC = new HttpTester(new URL(url + "/sc/"),
                        "DELETE", "",
                        Map.of(
                                "Knowledge-Base-Id", "http://example.com/kb2",
                                "Content-Type", "application/json",
