...
public class TestAskWithGapsEnabled {
	...
	@Test
	public void testAskWithGaps() throws IOException {
		...
		HttpTester registerKb = new HttpTester(new URL(url + "/sc"), "POST",
				"{\"knowledgeBaseId\": \"https://www.tno.nl/example/relationAsker\", \"knowledgeBaseName\": \"RelationAsker\", \"knowledgeBaseDescription\": \"A KB that asks for relations between people\", \"reasonerLevel\" : 4}",
		...
		assertTrue(result.contains("\"knowledgeGaps\":[[\"?a <http://example.org/isRelatedTo> ?b\"]]"));
	}
