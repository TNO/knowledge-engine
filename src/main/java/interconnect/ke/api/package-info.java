 ...
 * 
 * The {@link interconnect.ke.sc.SmartConnectorImpl} represents the gateway that
 ...
 * the {@link interconnect.ke.sc.SmartConnectorImpl} class. It should also register
 * {@link interconnect.ke.api.interaction.KnowledgeInteraction}s that let the
 * Knowledge Engine (and the other {@link interconnect.ke.sc.SmartConnectorImpl}s
