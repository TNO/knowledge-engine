...
public class SmartConnectorConfig {
	 ...
	 */
	@Deprecated
	public static final String CONF_KEY_KE_RUNTIME_HOSTNAME = "KE_RUNTIME_HOSTNAME";
	 ...
	 */
	public static final String CONF_KEY_KD_URL = "KD_URL";
	 ...
	 */
	public static final String CONF_KEY_KE_HTTP_TIMEOUT = "KE_HTTP_TIMEOUT";
	 ...
	 */
	public static final String CONF_KEY_KE_KB_WAIT_TIMEOUT = "KE_KB_WAIT_TIMEOUT";
	 ...
	 */
	public static final String CONF_KEY_KE_RUNTIME_EXPOSED_URL = "KE_RUNTIME_EXPOSED_URL";

	/**
	 * Key to configure the port at which the KER's peer-to-peer communication
	 * should happen. Only used in distributed mode.
	 */
	public static final String CONF_KEY_KE_RUNTIME_PORT = "KE_RUNTIME_PORT";
