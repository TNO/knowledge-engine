...
public class MessageConverter {
	...
	public static AskMessage fromJson(
			eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.AskMessage msg)
	...
	public static eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.AskMessage toJson(
			AskMessage msg) {
		var result = new eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.AskMessage();
	...
	public static AnswerMessage fromJson(
			eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.AnswerMessage msg)
			throws URISyntaxException {
	...
	public static eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.AnswerMessage toJson(
			AnswerMessage msg) {
		var result = new eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.AnswerMessage();
		result.setMessageId(msg.getMessageId().toString());
		result.setFromKnowledgeBase(msg.getFromKnowledgeBase().toString());
		result.setFromKnowledgeInteraction(msg.getFromKnowledgeInteraction().toString());
		result.setToKnowledgeBase(msg.getToKnowledgeBase().toString());
	...
	public static PostMessage fromJson(
			eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.PostMessage msg)
			throws URISyntaxException {
	...
	public static eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.PostMessage toJson(
			PostMessage msg) {
		var result = new eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.PostMessage();
		result.setMessageId(msg.getMessageId().toString());
		result.setFromKnowledgeBase(msg.getFromKnowledgeBase().toString());
		result.setFromKnowledgeInteraction(msg.getFromKnowledgeInteraction().toString());
		result.setToKnowledgeBase(msg.getToKnowledgeBase().toString());
	...
	public static ReactMessage fromJson(
			eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.ReactMessage msg)
			throws URISyntaxException {
	...
	public static eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.ReactMessage toJson(
			ReactMessage msg) {
		var result = new eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.ReactMessage();
		result.setMessageId(msg.getMessageId().toString());
		result.setFromKnowledgeBase(msg.getFromKnowledgeBase().toString());
		result.setFromKnowledgeInteraction(msg.getFromKnowledgeInteraction().toString());
		result.setToKnowledgeBase(msg.getToKnowledgeBase().toString());
	...
	public static ErrorMessage fromJson(
			eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.ErrorMessage msg)
			throws URISyntaxException {
	...
	public static eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.ErrorMessage toJson(
			ErrorMessage msg) {
		var result = new eu.knowledge.engine.smartconnector.runtime.messaging.inter_ker.model.ErrorMessage();
		result.setMessageId(msg.getMessageId().toString());
		result.setFromKnowledgeBase(msg.getFromKnowledgeBase().toString());
		result.setFromKnowledgeInteraction(msg.getFromKnowledgeInteraction().toString());
		result.setToKnowledgeBase(msg.getToKnowledgeBase().toString());
